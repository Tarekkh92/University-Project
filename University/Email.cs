...
namespace University
{
    class Email
    {
        ...
        public void PasswordRec(String id)
        {
            ...
            Body = "Hello " + ((Gender)(Convert.ToInt32(itemList[7]))).ToString() + itemList[3] + " " + itemList[4] + ", your password is: " + itemList[2];
        ...
        private void SendMail(List<String> AddressList, String Body, String Subject)
        {
            try
            {
                ...
                email.From = new MailAddress("UniTeamFour@gmail.com");
                email.Subject = Subject;
                email.Body = Body;

                SmtpServer.Port = 587;
                SmtpServer.Credentials = new System.Net.NetworkCredential("UniTeamFour", "uniteam4");
